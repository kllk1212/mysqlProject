...
public class JwtFix {
	...
	private static final String secret_key = "jaehoon"; // 비밀 키
	// private static long tokenValidMilisecond = 1000L * 60 * 60; // JWT 만료 시간 1시간


	public static String createAccessToken(int sno,String refreshToken) { // sno = 유저고유번호
		...
		try {
			...
			System.out.println("jwtBefore : " + jwtBefore);
